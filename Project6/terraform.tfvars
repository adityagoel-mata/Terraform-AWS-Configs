...
k8s_master_instance_name = "tf-k8s-master-ec2-instance"


#k8s_master_SG variables
k8s_master_ec2_sg_name           = "tf-k8s-master-ec2-sg"
k8s_master_ec2_sg_description    = "This allows HTTP requests"
k8s_master_ec2_sg_tag_name       = "tf-k8s-master-ec2-sg"
...
k8s_worker_instance_name = "tf-k8s-worker-ec2-instance"


#k8s_worker_SG variables
k8s_worker_ec2_sg_name           = "tf-k8s-worker-ec2-sg"
k8s_worker_ec2_sg_description    = "This allows HTTP requests"
k8s_worker_ec2_sg_tag_name       = "tf-k8s-worker-ec2-sg"
